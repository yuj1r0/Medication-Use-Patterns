...
#' @param highlight A character vector of the first set of SNPs in your dataset to highlight (selected color). 
#'   These SNPs should all be in your dataset.
#' @param highlight2 A character vector of tthe second set of SNPs in your dataset to highlight (another color). 
#'   These SNPs should all be in your dataset.
...
manhattan_2 <- function(x, chr="CHR", bp="BP", p="P", snp="SNP", 
                        col=c("gray10", "gray60"), chrlabs=NULL,
                        suggestiveline=-log10(1e-5), genomewideline=-log10(5e-8), 
                        highlight=NULL, highlight2=NULL, highlightcol="green3", highlightcol2="red", logp=TRUE, annotatePval = NULL, annotateTop = TRUE,...) {
  ...
  if (!is.null(highlight2)) {
    ...
    with(d.highlight2, points(pos, logp, col=highlightcol2, pch=20, ...)) 
  }
  # Highlight top SNPs
